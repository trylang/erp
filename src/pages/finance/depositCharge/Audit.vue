<template>
  <con-head tab="tab">
    <div slot="appendtab" class="tabmenu">
        <router-link to="/finance/takeadvancePay" v-if="takeadvancePay">押金收取管理</router-link>
        <router-link to="/finance/takeadvancePayAudit" v-if="takeadvancePayAudit">押金收取审核</router-link>
    </div>
