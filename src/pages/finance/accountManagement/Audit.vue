<template>
  <con-head tab="tab">
    ...
    <el-button v-if="variables.isActive === 'second'" type="primary" slot="append" @click="confirmBill">确认</el-button>
    <el-button type="primary" slot="append" @click="printContent">打印</el-button>          
    <!-- tab2当中的内容 --> 
      <section slot="preappend" v-if="variables.isActive === 'second'">
        <el-row>
          <el-col :span="7">
            <div class="searchbox">
              <input type="text" placeholder="请输入结算单号" v-model="query.settleNo1" @keyup.enter="getAccountConfirm"><i class="iconfont icon-sousuo"></i>
            </div>
          </el-col>
          <el-col :span="7" :offset="1">
            <div class="searchselect">
              <span class="inputname inputnameauto">物业性质</span>
              <el-select v-model="query.propertyType" @change="getAccountGroupByType(query.propertyType), getAccountConfirm()" filterable clearable placeholder="物业性质" class="dialogselect">
                <el-option
          ...
          <el-col :span="7" :offset="1">
            <div class="searchselect">
                ...
                <el-select v-model="query.settleGroupId" @change="getAccountConfirm" filterable clearable placeholder="结算组别" class="dialogselect">
                  <el-option
        ...
        <el-row>
          <el-col :span="7">
            <div class="searchselect">
                ...
                <el-select v-model="query.merchantId" @change="query.contractCode='', getAccountConfirm(),getMerchantId()" filterable clearable placeholder="商户名称" class="dialogselect">
          ...
          <el-col :span="7" :offset="1">
            <div class="searchselect">
                ...
                <el-select v-model="query.contractCode" @change="getAccountConfirm()" filterable clearable class="dialogselect">
                  <el-option label="全部" value=""></el-option>
                  <el-option
...
export default {
  ...
  methods: {
    ...
    async init() {
      ...
      this.selects.contracts = merchantsContracts ? merchantsContracts.data : [];
      await this.getAccountConfirm();
    }
  },
  watch: {
    'query.settleNo1': function() {
      this.$delay(()=>{
        this.getAccountConfirm();
      },300)
    }
