<template>
  <con-head tab="tab">
    ...
    <el-button v-if="variables.isActive === 'third'" type="primary" slot="append" @click="publishBill">发布</el-button>
    <el-button type="primary" slot="append" @click="printContent">打印</el-button>          
    <!-- tab3当中的内容 -->  
      <section slot="preappend" v-if="variables.isActive === 'third'">
        <el-row>
          <el-col :span="7">
            <div class="searchbox">
              <input type="text" placeholder="请输入结算单号" v-model="query.settleNo2" @keyup.enter="getAccountPulish"><i class="iconfont icon-sousuo"></i>
            </div>
          </el-col>
          <el-col :span="7" :offset="1">
            <div class="searchselect">
              <span class="inputname inputnameauto">物业性质</span>
              <el-select v-model="query.propertyType" @change="getAccountGroupByType(query.propertyType), getAccountPulish()" filterable clearable placeholder="物业性质" class="dialogselect">
                <el-option
          ...
          <el-col :span="7" :offset="1">
            <div class="searchselect">
                ...
                <el-select v-model="query.settleGroupId" @change="getAccountPulish" filterable clearable placeholder="结算组别" class="dialogselect">
                  <el-option
        ...
        <el-row>
          <el-col :span="7">
            <div class="searchselect">
                ...
                <el-select v-model="query.merchantId" @change="query.contractCode='', getAccountPulish(),getMerchantId()" filterable clearable placeholder="商户名称" class="dialogselect">
          ...
          <el-col :span="7" :offset="1">
            <div class="searchselect">
                ...
                <el-select v-model="query.contractCode" @change="getAccountPulish()" filterable clearable class="dialogselect">
                  <el-option label="全部" value=""></el-option>
                  <el-option
...
export default {
  ...
  methods: {
    ...
    async init() {
      ...
      this.selects.contracts = merchantsContracts ? merchantsContracts.data : [];
      await this.getAccountPulish();
    }
  },
  watch: {
    'query.settleNo2': function() {
      this.$delay(()=>{
        this.getAccountPulish();
      },300)
    }
