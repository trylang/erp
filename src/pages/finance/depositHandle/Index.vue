<template>
  <con-head tab="tab">
    <div slot="appendtab" class="tabmenu">
        <router-link to="/finance/dealAdvancePay" v-if="dealAdvancePay">押金处理</router-link>
        <router-link to="/finance/dealAdvancePayAudit" v-if="dealAdvancePayAudit">押金处理审核</router-link>
    </div>
