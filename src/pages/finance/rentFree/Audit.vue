<template>
    <con-head tab="tab">
        ...
        <el-row slot="preappend">
            <el-col :span="9">
                <div class="searchbox">
                    <input type="text" placeholder="请输入费用单号" v-model="query.costNo" @keyup.enter="getIrregularCost()"><i
            ...
            <el-col :span="9" :offset="6">
                <div class="searchselect">
                    ...
                    <el-select v-model="query.merchantId" placeholder="商户名称" filterable clearable
                               @change="query.contractCode='',getIrregularCost(),getMerchantId()" class="dialogselect">
        ...
        <el-row slot="preappend">
            ...
            <el-col :span="9" :offset="6">
                <div class="searchselect">
                    ...
                    <el-select v-model="query.contractCode" placeholder="请选择" filterable clearable
                               @change="getIrregularCost()" class="dialogselect">
                        <el-option label="全部" value=""></el-option>
                        <el-option
        ...
        <erp-table :header="header" :content="content" @currentPage="getCurrentPage"
