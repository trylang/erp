    ...
    <div v-loading.fullscreen="loading">
        <con-head tab="tab">
            <div slot="appendtab" class="tabmenu">
                <router-link to="/inner/office" v-if="office">写字楼管理</router-link>
                <router-link to="/inner/officeaudit" v-if="officeaudit">写字楼审核</router-link>
            </div>
        ...
        <el-dialog
                :title="listId?'编辑写字楼':'添加写字楼'"
                :visible.sync="dialogVisible"
                custom-class="customdialog">
            <div class="dialogbox">
                <div class="dialoginput">
                    <span class="inputname">编码</span>
                    <input class="inputtext" type="text" placeholder="请输入编号" v-model="unitInfoData.unitCode" :readonly="isStatus">
                </div>
                <div class="dialoginput">
...
<script>
    ...
    export default {
        ...
        computed:{
            office(){
                return this.$root.menus.indexOf('/inner/office') >= 0;
            },
            officeaudit(){
                return this.$root.menus.indexOf('/inner/officeaudit') >= 0;
            }
        },
        watch:{
            searchText(){
