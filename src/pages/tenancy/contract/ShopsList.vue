    ...
    <div v-loading.fullscreen="loading">
        <con-head tab="tab">
            <div slot="appendtab" class="tabmenu" v-if="this.$route.params.prototypeId==0">
                <router-link :to="routerListUrl+this.$route.params.prototypeId" v-if="shops">合同管理</router-link>
        ...
        computed: {
            shops(){
                switch (this.$route.params.prototypeId) {
                    case '0':
                        return this.$root.menus.indexOf('/inner/shopslist') >= 0;
                        break;
                    case '1':
                        return this.$root.menus.indexOf('/inner/cofficelist') >= 0;
                        break;
                    case '2':
                        return this.$root.menus.indexOf('/inner/fidlelist') >= 0;
                        break;
                    case '3':
                        return this.$root.menus.indexOf('/inner/adlist') >= 0;
                        break;
                }
            },
            shopsaudit(){
