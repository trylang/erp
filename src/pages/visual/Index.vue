...
<script>
// const Rtmap = require('../../sdk/js/sdk/rtmap_sdk.js');
// const Page = require('../../sdk/js/ui/indoormap_control/dist/ui.floorcontrol.js');
export default {
  data() {
    return {
  ...
  methods: {
    ...
    init: function() {
      ...
      var floor = "f1";
      var key = "k7i23869hd";
      Rtmap.DataProvider.getBuildInfo({ key: key, buildId: bid_id }, function(
        data
      ) {
        ...
        function initmap(domId, option) {
          ...
          //显示新的楼层切换控件
          Rtmap.FloorControl.show(
            function(e) {
              Rtmap.Scene.changeFloorTo(e, "", function() {});
            },
            option.floorinfo,
            { defaultFloor: floor.toUpperCase(), parentDom: $("#map_body") }
          );
