 ...
 * request: exportPlatformDaySalesSumListUsingPOST
 * url: exportPlatformDaySalesSumListUsingPOSTURL
 * method: exportPlatformDaySalesSumListUsingPOST_TYPE
 * raw_url: exportPlatformDaySalesSumListUsingPOST_RAW_URL
 * @param token - header中token字段
 * @param request - request
 */
export const exportPlatformDaySalesSumListUsingPOST = function(parameters = {}) {
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  const config = parameters.$config
  let path = '/report/salestatistic/export/platformdaysalessumlist'
  let body
  let queryParameters = {}
  let form = {}
  if (parameters['request'] !== undefined) {
...
export const exportPlatformDaySalesSumListUsingPOST_RAW_URL = function() {
  return '/report/salestatistic/export/platformdaysalessumlist'
}
export const exportPlatformDaySalesSumListUsingPOST_TYPE = function() {
  return 'post'
}
export const exportPlatformDaySalesSumListUsingPOSTURL = function(parameters = {}) {
  let queryParameters = {}
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  let path = '/report/salestatistic/export/platformdaysalessumlist'
  if (parameters.$queryParameters) {
 ...
 * request: exportPlatformPaymentManageListUsingPOST
 * url: exportPlatformPaymentManageListUsingPOSTURL
 * method: exportPlatformPaymentManageListUsingPOST_TYPE
 * raw_url: exportPlatformPaymentManageListUsingPOST_RAW_URL
 * @param token - header中token字段
 * @param request - request
 */
export const exportPlatformPaymentManageListUsingPOST = function(parameters = {}) {
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  const config = parameters.$config
...
export const exportPlatformPaymentManageListUsingPOST_RAW_URL = function() {
  return '/report/salestatistic/export/platformpaymentmanagelist'
}
export const exportPlatformPaymentManageListUsingPOST_TYPE = function() {
  return 'post'
}
export const exportPlatformPaymentManageListUsingPOSTURL = function(parameters = {}) {
  let queryParameters = {}
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  let path = '/report/salestatistic/export/platformpaymentmanagelist'
  if (parameters.$queryParameters) {
...
/**
 * 商户自助平台---交易明细，导出
 * request: exportPlatformSalesDetailUsingGET
 * url: exportPlatformSalesDetailUsingGETURL
 * method: exportPlatformSalesDetailUsingGET_TYPE
 * raw_url: exportPlatformSalesDetailUsingGET_RAW_URL
 * @param token - header中token字段
 * @param request - 自助平台交易明细导出时的参数
 */
export const exportPlatformSalesDetailUsingGET = function(parameters = {}) {
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  const config = parameters.$config
  let path = '/report/salestatistic/export/platformsalesdetail'
  let body
  let queryParameters = {}
  let form = {}
  if (parameters['request'] !== undefined) {
...
export const exportPlatformSalesDetailUsingGET_RAW_URL = function() {
  return '/report/salestatistic/export/platformsalesdetail'
}
export const exportPlatformSalesDetailUsingGET_TYPE = function() {
  return 'get'
}
export const exportPlatformSalesDetailUsingGETURL = function(parameters = {}) {
  let queryParameters = {}
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  let path = '/report/salestatistic/export/platformsalesdetail'
  if (parameters.$queryParameters) {
 ...
 * request: platformSalesDetailListUsingPOST
 * url: platformSalesDetailListUsingPOSTURL
 * method: platformSalesDetailListUsingPOST_TYPE
 * raw_url: platformSalesDetailListUsingPOST_RAW_URL
 * @param token - header中token字段
 * @param request - request
 */
export const platformSalesDetailListUsingPOST = function(parameters = {}) {
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  const config = parameters.$config
  let path = '/report/salestatistic/platformdaysalessumlist'
  let body
  let queryParameters = {}
  let form = {}
  if (parameters['request'] !== undefined) {
...
export const platformSalesDetailListUsingPOST_RAW_URL = function() {
  return '/report/salestatistic/platformdaysalessumlist'
}
export const platformSalesDetailListUsingPOST_TYPE = function() {
  return 'post'
}
export const platformSalesDetailListUsingPOSTURL = function(parameters = {}) {
  let queryParameters = {}
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  let path = '/report/salestatistic/platformdaysalessumlist'
  if (parameters.$queryParameters) {
 ...
 * request: platformPaymentManageListUsingPOST
 * url: platformPaymentManageListUsingPOSTURL
 * method: platformPaymentManageListUsingPOST_TYPE
 * raw_url: platformPaymentManageListUsingPOST_RAW_URL
 * @param token - header中token字段
 * @param request - request
 */
export const platformPaymentManageListUsingPOST = function(parameters = {}) {
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  const config = parameters.$config
...
export const platformPaymentManageListUsingPOST_RAW_URL = function() {
  return '/report/salestatistic/platformpaymentmanagelist'
}
export const platformPaymentManageListUsingPOST_TYPE = function() {
  return 'post'
}
export const platformPaymentManageListUsingPOSTURL = function(parameters = {}) {
  let queryParameters = {}
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  let path = '/report/salestatistic/platformpaymentmanagelist'
  if (parameters.$queryParameters) {
...
/**
 * 商户自助平台---交易明细，查询
 * request: platformSalesDetailUsingGET
 * url: platformSalesDetailUsingGETURL
 * method: platformSalesDetailUsingGET_TYPE
 * raw_url: platformSalesDetailUsingGET_RAW_URL
 * @param token - header中token字段
 * @param request - 自助平台交易明细查询时的参数
 */
export const platformSalesDetailUsingGET = function(parameters = {}) {
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  const config = parameters.$config
  let path = '/report/salestatistic/platformsalesdetail'
  let body
  let queryParameters = {}
  let form = {}
  if (parameters['request'] !== undefined) {
...
export const platformSalesDetailUsingGET_RAW_URL = function() {
  return '/report/salestatistic/platformsalesdetail'
}
export const platformSalesDetailUsingGET_TYPE = function() {
  return 'get'
}
export const platformSalesDetailUsingGETURL = function(parameters = {}) {
  let queryParameters = {}
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  let path = '/report/salestatistic/platformsalesdetail'
  if (parameters.$queryParameters) {
